...
*/
angular.module("$strap.config", [])
    .value("$strap.config", {}), angular.module("$strap.filters", ["$strap.config"]), angular.module("$strap.directives", ["$strap.config"]), angular.module("$strap", ["$strap.filters", "$strap.directives", "$strap.config"]), angular.module("$strap.directives")
    .directive("bsAlert", ["$parse", "$timeout", "$compile", function(t, e, n) {
    "use strict";
    return {
        restrict: "A",
        link: function(e, a, i) {
            ...
            i.bsAlert ? e.$watch(i.bsAlert, function(t, o) {
                r = t, a.html((t.title ? "<strong>" + t.title + "</strong> " : "") + t.content || ""), t.closed && a.hide(), n(a.contents())(e), (t.type || o.type) && (o.type && a.removeClass("alert-" + o.type), t.type && a.addClass("alert-" + t.type)), (angular.isUndefined(i.closeButton) || "0" !== i.closeButton && "false" !== i.closeButton) && a.prepend('<button type="button" class="close" data-dismiss="alert">×</button>')
            }, !0) : (angular.isUndefined(i.closeButton) || "0" !== i.closeButton && "false" !== i.closeButton) && a.prepend('<button type="button" class="close" data-dismiss="alert">×</button>'), a.addClass("alert")
                .alert(), a.hasClass("fade") && (a.removeClass("in"), setTimeout(function() {
                a.addClass("in")
            }));
            var s = i.ngRepeat && i.ngRepeat.split(" in ")
                .pop();
            a.on("close", function(t) {
                ...
                }, $.support.transition && a.hasClass("fade") ? a.on($.support.transition.end, n) : n()) : r && (t.preventDefault(), a.removeClass("in"), n = function() {
    ...
    .directive("bsButton", ["$parse", "$timeout", function(t) {
    "use strict";
    return {
        restrict: "A",
        require: "?ngModel",
        link: function(e, n, a, i) {
            if (i) {
                n.parent('[data-toggle="buttons-checkbox"], [data-toggle="buttons-radio"]')
                    .length || n.attr("data-toggle", "button");
    ...
    return {
        ...
        require: "?ngModel",
        compile: function(t) {
            t.attr("data-toggle", "buttons-checkbox")
                .find("a, button")
                .each(function(t, e) {
                $(e)
                    .attr("bs-button", "")
    ...
    return {
        ...
        compile: function(e, n) {
            return e.attr("data-toggle", "buttons-radio"), n.ngModel || e.find("a, button")
                .each(function(t, e) {
                $(e)
                    .attr("bs-button", "")
            }),
            function(e, n, a, i) {
                i && (t(function() {
                    n.find("[value]")
                        .button()
                        .filter('[value="' + i.$viewValue + '"]')
                        .addClass("active")
                }), n.on("click.button.data-api", function(t) {
                    e.$apply(function() {
                        i.$setViewValue($(t.target)
                            .closest("button")
                            .attr("value"))
                    })
    ...
    .directive("bsButtonSelect", ["$parse", "$timeout", function(t) {
    "use strict";
    return {
        restrict: "A",
        require: "?ngModel",
        link: function(e, n, a, i) {
            ...
            n.bind("click", function() {
                r = o(e), s = i ? e.$eval(a.ngModel) : n.text(), u = r.indexOf(s), l = u > r.length - 2 ? r[0] : r[u + 1], console.warn(r, l), e.$apply(function() {
    ...
    .directive("bsDatepicker", ["$timeout", "$strap.config", function(t, e) {
    "use strict";
    ...
    return {
        ...
        link: function(t, a, o, r) {
            var s = e.datepicker || {}, u = o.language || s.language || "en",
                l = o.dateType || s.type || "date",
                c = o.dateFormat || s.format || $.fn.datepicker.dates[u] && $.fn.datepicker.dates[u].format || "yyyy-mm-dd",
                d = n ? i("yyyy-mm-dd", u) : i(c, u);
            r && (r.$parsers.unshift(function(t) {
                return t ? "date" === l && angular.isDate(t) ? (r.$setValidity("date", !0), t) : angular.isString(t) && d.test(t) ? (r.$setValidity("date", !0), n ? new Date(t) : "string" === l ? t : $.fn.datepicker.DPGlobal.parseDate(t, $.fn.datepicker.DPGlobal.parseFormat(c), u)) : (r.$setValidity("date", !1), void 0) : (r.$setValidity("date", !0), null)
            }), r.$render = function() {
                return r.$modelValue && a.datepicker("update", r.$modelValue)
            }), n ? a.prop("type", "date")
                .css("-webkit-appearance", "textfield") : (r && a.on("changeDate", function(e) {
                t.$apply(function() {
                    r.$setViewValue("string" === l ? a.val() : e.date)
                })
            }), a.attr("data-toggle", "datepicker"), a.datepicker({
                autoclose: !0,
                format: c,
                language: u,
                forceParse: o.forceParse || !1
    ...
    .directive("bsDropdown", ["$parse", "$compile", "$timeout", function(t, e, n) {
    "use strict";
    var a = function(t, e) {
        return e || (e = ['<ul class="dropdown-menu" role="menu" aria-labelledby="drop1">', "</ul>"]), angular.forEach(t, function(t, n) {
            ...
            var i = "<li" + (t.submenu && t.submenu.length ? ' class="dropdown-submenu"' : "") + ">" + '<a tabindex="-1" ng-href="' + (t.href || "") + '"' + (t.click ? '" ng-click="' + t.click + '"' : "") + (t.target ? '" target="' + t.target + '"' : "") + ">" + (t.text || "") + "</a>";
            t.submenu && t.submenu.length && (i += a(t.submenu)
    ...
    .factory("$modal", ["$rootScope", "$compile", "$http", "$timeout", "$q", "$templateCache", function(t, e, n, a, i, o) {
    var r = function r(r) {
        function s(r) {
            r || (r = {});
            var s = r.scope || t.$new(),
                u = r.template;
            return i.when(o.get(u) || n.get(u, {
                cache: !0
            })
                .then(function(t) {
                return t.data
                ...
                .then(function(t) {
                var n = u.replace(".html", "")
                    .replace(/[\/|\.|:]/g, "-") + "-" + s.$id,
                    i = $('<div class="modal hide" tabindex="-1"></div>')
                        .attr("id", n)
                        .addClass("fade")
                        .html(t);
                return r.modalClass && i.addClass(r.modalClass), $("body")
                    .append(i), a(function() {
                    e(i)(s)
                }), s.$modal = function(t) {
                    i.modal(t)
    ...
    return {
        ...
        link: function(n, a, i) {
            var o = {
                ...
                scope: n,
                modalClass: i.modalClass || "",
                backdrop: 1 * i.backdrop || !0,
                keyboard: 1 * i.keyboard || !0,
                show: 1 * i.show || !1
            };
            t.when(e(o))
                .then(function(t) {
                a.attr("data-target", "#" + t.attr("id"))
                    .attr("data-toggle", "modal")
            })
        }
    }
}]), angular.module("$strap.directives")
    .directive("bsNavbar", ["$location", function(t) {
    "use strict";
    return {
        restrict: "A",
        link: function(e, n) {
    ...
    .directive("bsPopover", ["$parse", "$compile", "$http", "$timeout", "$q", "$templateCache", function(t, e, n, a, i, o) {
    "use strict";
    return $("body")
        .on("keyup", function(t) {
        27 === t.keyCode && $(".popover.in")
            .each(function() {
            $(this)
                .popover("hide")
        })
        ...
        link: function(a, r, s) {
            var u = t(s.bsPopover),
                l = (u.assign, u(a)),
                c = {};
            angular.isObject(l) && (c = l), i.when(c.content || o.get(l) || n.get(l, {
                cache: !0
            }))
                .then(function(t) {
    ...
    .directive("bsSelect", ["$timeout", function(t) {
    "use strict";
    return {
        restrict: "A",
        require: "?ngModel",
    ...
    .directive("bsTabs", ["$parse", "$compile", "$timeout", function(t, e, n) {
    "use strict";
    ...
    return {
        ...
        compile: function() {
            return function(e, a, i, o) {
                ...
                var s, u, l, c = a.find("ul.nav-tabs"),
                    d = a.find("div.tab-content"),
                    p = 0;
                n(function() {
                    d.find("[data-title], [data-tab]")
                        .each(function(t) {
                        var n = angular.element(this);
                        s = "tab-" + e.$id + "-" + t, u = n.data("title") || n.data("tab"), l = !l && n.hasClass("active"), n.attr("id", s)
                            .addClass("tab-pane"), i.fade && n.addClass("fade"), e.panes.push({
                            id: s,
                            title: u,
                            content: this.innerHTML,
                            active: l
                        })
                    }), e.panes.length && !l && (d.find(".tab-pane:first")
                        .addClass("active" + (i.fade ? " in" : "")), e.panes[0].active = !0)
                    ...
                    angular.isUndefined(t) || (p = t, setTimeout(function() {
                        ...
                        e.hasClass("active") || e.children("a")
                            .tab("show")
                    }))
                }))
            }
    ...
    .directive("bsTimepicker", ["$timeout", function(t) {
    "use strict";
    ...
    return {
        ...
        link: function(n, a, i, o) {
            ...
            }), a.attr("data-toggle", "timepicker"), a.parent()
                .addClass("bootstrap-timepicker"), a.timepicker();
            var s = a.data("timepicker"),
                u = a.siblings('[data-toggle="timepicker"]');
            u.length && u.on("click", $.proxy(s.showWidget, s))
        }
    }
}]), angular.module("$strap.directives")
    .directive("bsTooltip", ["$parse", "$compile", function(t) {
    "use strict";
    return {
        restrict: "A",
        scope: !0,
    ...
    .directive("bsTypeahead", ["$parse", function(t) {
    "use strict";
    return {
        restrict: "A",
        require: "?ngModel",
        link: function(e, n, a, i) {
            ...
            s.lookup = function() {
                ...
                n.on("focus", function() {
                    0 === n.val()
                        .length && setTimeout(n.typeahead.bind(n, "lookup"), 200)
                })
            })
        }
    }
